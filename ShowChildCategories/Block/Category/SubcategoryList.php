...
class SubcategoryList extends Template
{
    ...
    /**
     * Get the maximum child depth set for the current category.
     *
     * Retrieves the custom attribute 'max_child_depth' from the current category.
     *
     * @return int
     */
    ...
    {
        $currentCategory = $this->getCurrentCategory();
        return $currentCategory ? (int)$currentCategory->getData('max_child_depth') : 0;
    }
}
